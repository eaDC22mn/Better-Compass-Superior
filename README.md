...
- Preset images for use as background image.
- An additional quick features menu with the most useful features.
- Shortcut favicon badges that can be pinned to the navbar.
